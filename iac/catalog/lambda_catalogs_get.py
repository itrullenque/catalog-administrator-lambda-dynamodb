...
class LambdaCatalogsGet:
    def __init__(
        ...
        self.stack = stack
        self.id = "lambda_catalogs_get_lambda"
        self.name = "lambda_catalogs_get"
    ...
    def __create_function(self):
        func = aws_lambda.Function(
            ...
            code=aws_lambda.Code.from_asset(path="iac/assets/lambda_catalogs_get"),
            role=self.role(),
            memory_size=1024,
        )
        return func
    ...
    def role(self):
        ...
        lambda_dynamodb_policy_statement.add_actions("dynamodb:Scan")
